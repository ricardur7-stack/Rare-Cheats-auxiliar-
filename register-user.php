    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="register-user.php" class="nav-link active">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                                    <strong class="card-title" v-if="headerText">Register User</strong>
                                </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Vendedor"  name='Vendedor' data-required="true" data-type="email" data-error-message="Vendedor is required" required>
                  </div>
